...
<section class="p-5 bg-secondary">
    <div class="container">
    <div class="text-white text-start"> <span class="border-start  border-5  border-info px-3 display-6 fw-bold text-uppercase">De tu Interes</span> </div>
            ...
            <div class="col col-md-4 col-lg-2 p-2">
                <div class="single-card card-style-one  elementor-animation-shrink">
                    ...
                    <a class=" info-<?php echo $color.""; ?> position-relative w-100 p-3"
                        ...
                        <span class="row">
                            <span class="col-9 text-white text-uppercase" style="height:60px; font-size:0.83em;">
